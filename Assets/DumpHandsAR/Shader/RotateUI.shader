...
Shader "Custom/RotateUI"
{
    Properties
    {
        ...
        _RotationAngle ("Rotation Angle", Float) = 90.0
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t v)
            {
                ...
                const float2 scaleValue = float2(1/_Scale.x, 1/_Scale.y);
                v.texcoord.xy = mul(scale( scaleValue ), v.texcoord.xy);
                v.texcoord.xy += float2(0.5,0.5);
